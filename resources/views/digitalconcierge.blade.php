...
<head>
  ...
  <title>Digital Concierge | Smart Assistance - The Kicukiro Heights</title>
  <style>
...
<body>
  ...
  <div class="container">
    <div class="intro">
      <h2>Your Personal Assistant — Anytime, Anywhere</h2>
      <p>The <strong>Digital Concierge</strong> puts every service at your fingertips.  
      From in-room dining to airport pickup, spa booking, or city recommendations —  
      access it all through our dedicated mobile app or smart tablets available in every suite.</p>
    </div>
  ...
  <footer>
    <p>&copy; 2025 The Kicukiro Heights | <a href="/">Back to Home</a></p>
  </footer>
</body>
</html>
